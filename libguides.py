...
## CC BY license
##
## This harvests the library research guides authored by librarians from Boston University Libraries
##
...
os.remove('/home/primo/libguides/LibGuides.xml')
os.remove('/home/primo/libguides/LibGuides.xml.tar.gz')

if not test:
    ## open the xml file and write the header
    f = open('LibGuides.xml', 'wb')
...
tar = tarfile.open('/home/primo/libguides/LibGuides.xml.tar.gz' , 'w:gz')
tar.add('LibGuides.xml')
tar.close()
