...
## CC BY license
##
## This harvests the library research guides authored by librarians from Boston Theology Library
##
...
os.remove('/home/primo/libguides/TheoGuides.xml')
os.remove('/home/primo/libguides/TheoGuides.xml.tar.gz')
